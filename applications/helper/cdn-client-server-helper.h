 ...
 */
#ifndef CDN_CLIENT_SERVER_HELPER_H
#define CDN_CLIENT_SERVER_HELPER_H
 ...
 */
class CdnServerHelper
{
public:
  /**
   * Create CdnServerHelper which will make life easier for people trying
 ...
 *
 */
class CdnClientHelper
{

public:
  /**
   * Create CdnClientHelper which will make life easier for people trying
   * to set up simulations with cdn-client-server.
   *
   */
  CdnClientHelper ();
   ...
   * to set up simulations with cdn-client-server.
   *
   * \param ip The IPv4 address of the remote CDN server
   * \param port The port number of the remote CDN server
   */

  CdnClientHelper (Ipv4Address ip, uint16_t port);
  /**
   *  Create CdnClientHelper which will make life easier for people trying
  ...
  CdnClientHelper (Ipv6Address ip, uint16_t port);
  /**
   *  Create CdnClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
  ...
  CdnClientHelper (Address ip, uint16_t port);
...
/**
 * \ingroup udpclientserver
 * Create CdnTraceClient application which sends UDP packets based on a trace
...
*/
class CdnTraceClientHelper
{
public:
  /**
   * Create CdnTraceClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
   */
  CdnTraceClientHelper ();
   ...
   */
  CdnTraceClientHelper (Address ip, uint16_t port, std::string filename);
  /**
   * Create CdnTraceClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
   ...
   * \param filename the file from which packet traces will be loaded
   */
  CdnTraceClientHelper (Ipv4Address ip, uint16_t port, std::string filename);
  /**
   * Create CdnTraceClientHelper which will make life easier for people trying
   * to set up simulations with udp-client-server.
   *
   ...
   * \param filename the file from which packet traces will be loaded
   */
  CdnTraceClientHelper (Ipv6Address ip, uint16_t port, std::string filename);
